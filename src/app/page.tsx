...
export default function Home() {
  return (
    <>
      <HomeItems />
      <div className=' h-screen bg-slate-600 rounded-3xl'>HELLO</div>
      <div className=' h-screen bg-red-600 rounded-3xl'>HELLO</div>
    </>
    // <div>
    //   {/* <HomeGrid /> */}
    //   <div className='flex'>
    //     <div className='text-5xl m-3 h-52  md:h-72  w-full bg-white text-black  col-start-1 col-span-12 rounded-[4.5rem] text-center flex justify-center items-center'>
    //       The Craftsmen{" "}
    //     </div>
    //   </div>
